...
// step6 가입하는 회원의 성향 키워드 선택
class UserMyKeywordStep extends StatefulWidget {
  final Function nextStep;
  final dynamic userData;
  final dynamic signupNotifier;

  const UserMyKeywordStep(this.nextStep, this.userData, this.signupNotifier,
      {super.key});

  @override
  State<UserMyKeywordStep> createState() => _UserMyKeywordStepState();
}

class _UserMyKeywordStepState extends State<UserMyKeywordStep> {
  ...
  void checkValidation() async {
    ...
    int result =
        await widget.signupNotifier.validationMyKeywordInfo(selectedKeywordIds);
